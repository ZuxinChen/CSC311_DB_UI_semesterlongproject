...
public class DbConnectivityClass {
    ...
    final static String SQL_SERVER_URL = "jdbc:mysql://csc311chenserver.mysql.database.azure.com/";//update this server name
    final static String DB_URL = "jdbc:mysql://csc311chenserver.mysql.database.azure.com/"+DB_NAME;//update this database name
    final static String USERNAME = "csc311chenserver";// update this username
    final static String PASSWORD = "Chen1500Server";// update this password
    ...
    public ObservableList<Person> getData() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String major = resultSet.getString("position");
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                lg.makeLog("ID: " + id + ", Name: " + first_name + " " + last_name + " "
                        + ", Position: " + major + ", Department: " + department);
            }
            preparedStatement.close();
            conn.close();
        } catch (SQLException e) {
    ...
    public void listAllUsers() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                lg.makeLog("ID: " + id + ", Name: " + first_name + " " + last_name + " "
                        + ", Department: " + department + ", Position: " + major + ", Email: " + email);
            }
    ...
    public void insertUser(Person person) {
        ...
        try {
            Connection conn = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD);
            String sql = "INSERT INTO users (first_name, last_name, department, position, email, imageURL) VALUES (?, ?, ?, ?, ?, ?)";
            PreparedStatement preparedStatement = conn.prepareStatement(sql);
    ...
    public void editUser(int id, Person p) {
        ...
        try {
            Connection conn = DriverManager.getConnection(DB_URL, USERNAME, PASSWORD);
            String sql = "UPDATE users SET first_name=?, last_name=?, department=?, position=?, email=?, imageURL=? WHERE id=?";
            PreparedStatement preparedStatement = conn.prepareStatement(sql);
